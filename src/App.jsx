  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/faceclassification" element={<FaceClassifi />} /> /* 친구의 이름이 무엇인가요 */
        <Route path="/faceclassification2" element={<FaceClassifi2 />} /> /* (새로운 친구)님이 맞나요? */
        <Route path="/faceclassification3" element={<FaceClassifi3 />} /> /* !(윤선)님이 맞나요? */
        <Route path="/choice" element={<Choice />} /> /* !사진 속 친구를 선택해주세요. */
        <Route path="/facerecognition1" element={<NumofPp />} /> /* 사진 속에서 저장하고자 하는 친구를 선택해주세요*/
        <Route path="/facerecognition2" element={<NumofPp2 />} /> /* !추가로 등록하실 친구가 있나요? */
